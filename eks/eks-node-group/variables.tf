/* cluster_name – (Required) Name of the EKS Cluster.
 ...
 - (Optional) Type of Amazon Machine Image (AMI) associated with the EKS Node Group.AL2_x86_64 | AL2_x86_64_GPU | AL2_ARM_64 | CUSTOM | BOTTLEROCKET_ARM_64 | BOTTLEROCKET_x86_64
